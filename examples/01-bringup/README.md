...
1. Copy one of the `catalog/<vendor>/*.yaml` entries from
   `examples/03-profiles/catalog/` (or author your own).
...
`examples/02-station/` is the full Tier 2 example.
`examples/03-profiles/` is the full Tier 3 example with profiles,
