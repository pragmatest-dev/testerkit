...
The same cases drive both ``testerkit benchmark`` and the perf test suite
...
if TYPE_CHECKING:
    from testerkit.benchmark.scenario import Coefficients, ConcurrencySweep, StorageFootprint
    from testerkit.benchmark.system import ResourceFootprint
