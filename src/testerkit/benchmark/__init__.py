"""TesterKit data-store benchmark — measure your machine's per-store ceiling.

``testerkit benchmark`` runs the same store workloads the perf test suite
...
from testerkit.benchmark.runner import BenchmarkOptions, run_benchmark, write_report
