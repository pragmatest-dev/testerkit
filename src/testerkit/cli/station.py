...
def station_init(station_id: str, name: str, location: str | None):
    ...
    Example:
        ...
        testerkit station init --station-id bench_01 --name "Engineering Bench"
    """
    ...
    from testerkit.store import normalize_and_check_instrument_types
    ...
    click.echo("Write a test:   testerkit new-test <name>")
...
def station_validate(station_id: str | None, strict: bool):
    ...
    Example:
        testerkit station validate bench_01
        testerkit station validate --strict
    """
    from testerkit.instruments.discovery import get_info_visa
    from testerkit.instruments.loader import (
        find_instruments_dir,
        find_stations_dir,
        resolve_station_instruments,
    )
    from testerkit.store import load_instrument_files, load_station
...
def station_update(station_id: str):
    ...
    Example:
        testerkit station update bench_01
    """
    from testerkit.instruments.discovery import get_info_visa
    from testerkit.instruments.loader import (
        find_instruments_dir,
