...
from testerkit.cli._time import format_ts, resolve_since_until
...
def show(
    ...
    Examples:
        testerkit show abc123
        testerkit show abc123 -f html
        testerkit show abc123 -f pdf -o reports/
        testerkit show abc123 -f json -o result.json
    """
    data_dir = _get_data_dir(data_dir)

    from testerkit.reports.core import load_run_data

    if fmt:
        # Report generation mode
        from testerkit.reports.core import generate_report
    ...
    if env:
        from testerkit.sbom import environment_from_parquet, format_environment_table
...
def export(
    ...
    Examples:
        ...
        testerkit export abc123 -f csv

        testerkit export abc123 -f stdf -o exports/stdf/
    """
    from testerkit.data.subscribers import get_subscriber_class, replay_to_subscriber
...
def _list_export_formats() -> list[str]:
    ...
    from testerkit.data.subscribers import list_subscribers
...
def sbom(run_id: str, data_dir: str | None, output: str | None):
    ...
    Examples:
        testerkit sbom abc123
        testerkit sbom abc123 -o sbom.json
    """
    from testerkit.sbom import environment_from_parquet, generate_cyclonedx
