...
def validate(paths, file_type, as_json):
    ...
    Examples:
        testerkit validate catalog/keysight_34461a.yaml
        testerkit validate instruments/ --type instrument_asset
        testerkit validate catalog/ stations/
        testerkit validate
    """
    from testerkit.validation import validate_yaml
    ...
    if paths:
        ...
        # Also check testerkit.yaml in project root
        project_yaml = Path.cwd() / "testerkit.yaml"
