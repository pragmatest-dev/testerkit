...
from testerkit.data._ipc_writer import BufferedIPCWriter, read_ipc_batches
...
# central registry (one home); see ``testerkit.data.schema_versions``.
...
# :data:`testerkit.data.events.TYPED_PAYLOAD_COLUMNS` for the rationale
...
class EventSubscriber:
    ...
    Used by the ``testerkit export`` CLI replay path (per-format
    converters in :mod:`testerkit.data.exporters` — csv/json/stdf/hdf5/
