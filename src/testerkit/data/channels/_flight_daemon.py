...
Usage (internal — not called directly)::
    ...
    python -m testerkit.data.channels._flight_daemon <channels_dir> <host> <port>
"""
...
from testerkit.data._duckdb_flight_server import DuckDBFlightServer
from testerkit.data.channels.flight_manager import FlightDaemonManager
from testerkit.data.channels.server import register_channel_hooks
