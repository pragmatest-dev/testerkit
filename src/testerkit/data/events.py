"""Typed event hierarchy for the TesterKit event log.
...
class SessionStarted(EventBase):
    ...
    def from_station(
        ...
        *,
        ...
        If ``site_count`` is None, reads ``_TESTERKIT_SITE_COUNT`` env var
...
class RunStarted(EventBase):
    ...
    # Environment snapshot (small — python/testerkit versions + fingerprint)
