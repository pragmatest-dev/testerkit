...
``testerkit.analysis.*`` / ``testerkit.data.event_store`` — those remain
...
from testerkit.analysis.measurement_facets import ColumnSchema, FieldRef, FieldRole
...
from testerkit.data._store import Store
