...
Wraps testerkit.matching.service to provide UI-specific matching:
...
from testerkit.models.capability import Capability, InstrumentCapability, Signal
...
def _get_channels_satisfying(
    ...
    for cap in capabilities:
        ...
        if raw_channels and isinstance(raw_channels, list):
            ...
            from testerkit.utils.ranges import expand_range
