...
from testerkit.ui.pages.designer.graph import build_graph_option
from testerkit.ui.pages.designer.matching import (
    auto_suggest_connections,
    get_compatible_channels_for_pin,
)
from testerkit.ui.pages.designer.properties import (
...
from testerkit.ui.shared.components import data_table
...
def designer_page(part: str = "", station: str = "", fixture: str = ""):
    ...
    with ui.column().classes("w-full p-6 gap-4"):
        # --- Experimental marker — this area is less mature than the rest of TesterKit ---
        with ui.row().classes("items-center gap-2 text-amber-600"):
            ui.icon("science").classes("text-base")
            ui.label(
                "Experimental — the System Designer is less mature than the rest of TesterKit."
            ).classes("text-sm")
