...
from testerkit.ui.shared.services import discover_stations, get_recent_runs
    ...
    with ui.column().classes("w-full p-6 gap-6"):
        with ui.card().classes("w-full max-w-2xl mx-auto"):
            ...
            with ui.column().classes("gap-4 mt-6"):
                ...
                with ui.row().classes("items-start gap-3"):
                    ...
                    with ui.column().classes("gap-1"):
                        ...
                        ui.label("or from CLI: testerkit station init").classes(
                ...
                with ui.row().classes("items-start gap-3"):
                    ...
                    with ui.column().classes("gap-1"):
                        ...
                        ui.label("testerkit new-test <name>").classes(
            ...
            with ui.row().classes("items-center gap-2 mt-2"):
                ...
                ui.label("testerkit init --starter").classes("text-sm font-mono text-slate-500")
