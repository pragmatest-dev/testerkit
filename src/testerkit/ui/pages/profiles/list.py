...
from testerkit.ui.shared.components import data_table, page_layout
from testerkit.ui.shared.layout import create_layout
from testerkit.ui.shared.services import discover_profiles


@ui.page("/profiles")
def profiles_page():
    """Profiles list — every profile declared in ``testerkit.yaml`` or under
        ...
        if not rows_data:
            with ui.card().classes("w-full p-6 text-center"):
                ...
                ui.label(
                    ...
                    "in testerkit.yaml. See the profiles reference for the schema."
