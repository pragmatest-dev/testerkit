...
from testerkit.ui.components.artifact_viewer import list_artifacts, render_artifact_buttons
        ...
        with ui.card().classes("w-full sticky top-0 z-10").props('data-testid="result-header"'):
            ...
            with ui.card_section().classes("py-2 px-3"):
                with ui.row().classes("flex-wrap gap-x-10 gap-y-2 w-full"):
                    ...
                    # a <span class="testerkit-time"> wrapper for browser-local
...
def _render_timeline_tab(
    ...
    *,
    ...
    from testerkit.ui.components.execution_gantt import render_execution_gantt
