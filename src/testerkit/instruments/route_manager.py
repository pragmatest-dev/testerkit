...
from testerkit.instruments.locks import ResourceMeta, acquire_resource
from testerkit.instruments.switch import SwitchDriver
...
class RouteManager:
    ...
    def _emit_route_closed(self, connection_name: str, route: SwitchRoute) -> None:
        ...
        if self._event_log is None:
            return
        from testerkit.data.events import RouteClosed
    ...
    def _emit_route_opened(self, connection_name: str, route: SwitchRoute) -> None:
        ...
        if self._event_log is None:
            return
        from testerkit.data.events import RouteOpened
