...
Profile overrides (``demo/advanced/litmus.yaml``) collapse the sweeps
to a single nominal point under ``--litmus-profile production`` for
screening runs; ``characterization`` uses the full sweeps.
"""
