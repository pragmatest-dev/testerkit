...
def new_fixture_page():
    ...
    with ui.column().classes("w-full p-6 gap-6"):
        ...
        with ui.row().classes("items-center gap-2"):
            ...
            ui.label("Create New Fixture").classes(
            ...
            with ui.card_section():
                ...
                with ui.column().classes("gap-4 w-full"):
                    ...
                    with ui.column().classes("gap-1 w-full"):
                        ...
                        ui.label(
                            "Associate this fixture with a product (optional)"
                        ).classes("text-xs text-slate-400")
                        ui.select(
                    ...
                    # Product revision
                    with ui.column().classes("gap-1 w-full"):
                        ui.label("Product Revision").classes(
                            "text-sm font-medium text-slate-700"
                        )
                        ...
                        ui.input(
                            ...
                            on_change=lambda e: form.update(
                                {"product_revision": e.value.strip()}
                            ),
                        ).props("outlined dense").classes("w-full")
            ...
            with ui.card_section():
                with ui.row().classes("items-start gap-3"):
                    ...
                    with ui.column().classes("gap-1"):
                        ui.label("What is a Fixture?").classes(
                        ...
                        ui.label(
                            "After creating the fixture, you can add pin mappings."
                        ).classes("text-sm text-blue-600")
