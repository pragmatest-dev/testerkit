...
For motivation (why AI integration at all), see [concepts/why-ai-integration](../concepts/why-ai-integration.md). For setup commands (`litmus setup <client>`), see [how-to/mcp-integration](../how-to/mcp-integration.md).
