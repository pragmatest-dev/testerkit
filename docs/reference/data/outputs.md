...
testerkit show abc123 -f json         # JSON
```

### `testerkit export <run_id> -f <format> [-o <dir>]`
...
testerkit export abc123 -f mdf4 -o exports/mdf4/          # MDF4 (requires [mdf4])
```
...
| pdf | `testerkit show` | weasyprint | `pip install testerkit[pdf]` | Universal |
