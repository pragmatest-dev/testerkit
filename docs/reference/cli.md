...
- [MCP tools](../how-to/overview/mcp-integration.md) — the agent-side parallel to most `testerkit` subcommands
- [Configuration](configuration.md) — YAML files the CLI reads
- [API reference](runtime/api.md) — HTTP routes the `testerkit serve` UI mounts
