...
- [Stream continuous instrument data into a live channel](stream-live-channel.md) — push samples from a script or REPL and watch the channel panel update in real time
