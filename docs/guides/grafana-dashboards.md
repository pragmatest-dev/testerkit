...
No Grafana plugins required. Litmus includes a pgwire server (PostgreSQL wire protocol over DuckDB) that Grafana's built-in PostgreSQL datasource connects to directly.
