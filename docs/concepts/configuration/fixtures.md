...
| `dut_pin` | Part pin this connection is wired to (must match a `pins.<name>` key in the part spec) |
...
- [Parts](parts.md) — what pins and characteristics get declared on the DUT side
