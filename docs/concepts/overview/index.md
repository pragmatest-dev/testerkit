...
- [Platform vs framework](platform-vs-framework.md) — TesterKit owns infrastructure (configuration, data, instrumentation, AI / operator surface); pytest owns test execution
