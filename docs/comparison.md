...
| | **Litmus** | **OpenHTF** | **NI TestStand** | **OpenTAP / PathWave** | **htf (HILSTER)** | **pytest (plain)** |
|---|---|---|---|---|---|---|
| Language | Python | Python | LabVIEW/.NET | .NET/C#/Python | Python | Python |
| License | Apache-2.0 | Apache-2.0 | Commercial | Open-source (OpenTAP) / Commercial (PathWave) | Commercial | MIT |
| First release | 2025 | 2016 | ~2000 | 2019 | ~2020 | 2004 |
...
|---|:---:|:---:|:---:|:---:|:---:|:---:|
| Test sequencing | ✅ YAML sequences | ✅ Phase lists | ✅ Visual editor | ✅ Test plans | ✅ Code-defined | ✅ Collection |
| Parametric sweeps | ✅ Vector expansion (product, zip, range) | ❌ Manual loops | ✅ Sweep/loop steps | ✅ Sweep operator | ❌ | ✅ `parametrize` |
| Retry on failure | ✅ Per-step config | ❌ | ✅ | ✅ | ✅ | ❌ (needs plugin) |
| Skip-on-dependency | ✅ | ❌ | ✅ | ✅ | ❌ | ❌ (needs plugin) |
...
| Feature | **Litmus** | **OpenHTF** | **TestStand** | **OpenTAP** | **htf** | **pytest** |
|---|:---:|:---:|:---:|:---:|:---:|:---:|
| Typed measurements | ✅ Pydantic models | ✅ Measurement API | ✅ | ✅ | ✅ | ❌ |
| Limit comparators | ✅ 10 ATML types (EQ, GELE, GTLT, etc.) | ✅ Validators | ✅ | ✅ | ✅ | ❌ |
| Spec-driven limits | ✅ Product YAML → auto-derived | ❌ Hardcoded | 🟡 External file | ❌ | ❌ | ❌ |
...
| Feature | **Litmus** | **OpenHTF** | **TestStand** | **OpenTAP** | **htf** | **pytest** |
|---|:---:|:---:|:---:|:---:|:---:|:---:|
| Config format | YAML (Pydantic-validated) | Python code | XML/binary | XML | Python code | `conftest.py` |
...
| Non-dev editable | ✅ YAML, no code changes | ❌ Python only | ✅ GUI | ✅ GUI | ❌ | ❌ |

### Operator Experience

| Feature | **Litmus** | **OpenHTF** | **TestStand** | **OpenTAP** | **htf** | **pytest** |
|---|:---:|:---:|:---:|:---:|:---:|:---:|
| Operator UI | ✅ Browser-based (NiceGUI) | 🟡 Basic web GUI | ✅ Full operator interface | ✅ Editor GUI | ✅ Web UI | ❌ |
| Live test status | ✅ Real-time via journal streaming | 🟡 | ✅ | ✅ | ✅ | ❌ |
| Operator dialogs | ✅ Confirm, choice, input, image | ❌ | ✅ | ✅ | ✅ Interactive steps | ❌ |
...
| Feature | **Litmus** | **OpenHTF** | **TestStand** | **OpenTAP** | **htf** | **pytest** |
|---|:---:|:---:|:---:|:---:|:---:|:---:|
| Storage format | Parquet (columnar, open) | Proto/JSON callbacks | Binary/SQL | CSV/XML/custom | SQLite/JSON | None |
| Query engine | ✅ DuckDB (SQL over Parquet) | ❌ | ✅ Proprietary | ❌ | ❌ | ❌ |
| FPY / Cpk / SPC | ✅ Built-in analysis module | ❌ (needs TofuPilot) | ✅ | ❌ | ❌ | ❌ |
| Trend analysis | ✅ | ❌ | ✅ | ❌ | ❌ | ❌ |
...
| Step-by-step tutorial | ✅ 9-part series | ❌ | ✅ | ✅ | ✅ | ✅ |
| Working demo project | ✅ `demo/` with 30 tests | 🟡 Examples only | ✅ | ✅ | 🟡 | ❌ |
...
| Feature | **Litmus** | **OpenHTF** | **TestStand** | **OpenTAP** | **htf** | **pytest** |
|---|:---:|:---:|:---:|:---:|:---:|:---:|
| Existing pytest tests | ✅ Drop-in plugin | N/A | ❌ | ❌ | ❌ | N/A |
...
| | **Litmus** | **OpenHTF** | **TestStand** | **OpenTAP** | **htf** | **pytest** |
|---|---|---|---|---|---|---|
| Framework | Free (Apache-2.0) | Free (Apache-2.0) | ~$5,000+/seat | Free (MPL-2.0) | Commercial | Free (MIT) |
| Deployment | Free | Free | Per-station license | Free | Per-station | Free |
| Instruments | Bring your own | Bring your own | NI preferred | Keysight preferred | Bring your own | Bring your own |
...
3. **Analytics out of the box** — Parquet + DuckDB gives you FPY, Cpk, trend analysis, and Pareto charts without a separate analytics platform. OpenHTF users need TofuPilot ($) for this.
